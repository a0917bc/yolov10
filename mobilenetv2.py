...
# Remove leading underscore(_) since it cause import to ignore
...
class MobileNetV2(nn.Module):
    def __init__(self, num_channels=1, num_classes=4, width_mult=1.0, inverted_residual_setting=None, round_nearest=8):
        """
