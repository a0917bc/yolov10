...
class GatedCNNBlock(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.conv = nn.Conv2d(dim, hidden*2, kernel_size=1, padding=0) # nn.Linear(dim, hidden * 2)
        ...
        self.fc2 = nn.Conv2d(hidden, dim, kernel_size=1, padding=0) # nn.Linear(hidden, dim)
